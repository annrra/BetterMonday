    ...
    <>
      <div className={styles.playbook}>
        <div className={styles.preface}>
          ...
          >Tweak</span> anything, challenge anything or{" "}
          <span
            onClick={() => setActivePanel('media')}
            className={styles.tab}
          >frame</span> it differently — good results will follow.
        </div>
        {activePanel === "manual" && (
        ...
        {activePanel === "media" && (
          <div className={styles['media-view']}>
            ...
            <div className={styles.caption}>
              Any resemblance to actual persons,<br />
              living or dead, is purely coincidental.
            </div>
          </div>
        )}
      </div>
      <div className={classNames(styles['heart-pointer'], { [styles['ismedia']]: activePanel === 'media' })}>
        <svg
          viewBox="0 0 254 233"
          fill="none"
