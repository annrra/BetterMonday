...
const securityHeaders = [
  {
    ...
    value: `
      ...
      connect-src 'self' https://api.bettermonday.org https://va.vercel-scripts.com https://vitals.vercel-insights.com https://cloud.umami.is https://api-gateway.umami.dev;
